(() => {
      ...
      (function() {
        ...
        var runInContext = function runInContext2(context) {
          ...
          function arraySample(array2) {
            var length = array2.length;
            return length ? array2[baseRandom(0, length - 1)] : undefined;
          }
          ...
          function baseIntersection(arrays, iteratee2, comparator) {
            ...
            while (othIndex--) {
              ...
              caches[othIndex] = !comparator && (iteratee2 || length >= 120 && array2.length >= 120) ? new SetCache(othIndex && array2) : undefined;
            }
            array2 = arrays[0];
          ...
          function baseNth(array2, n) {
            ...
            n += n < 0 ? length : 0;
            return isIndex(n, length) ? array2[n] : undefined;
          }
          ...
          function baseSortedIndexBy(array2, value, iteratee2, retHighest) {
            ...
            while (low < high) {
              var mid = nativeFloor((low + high) / 2), computed = iteratee2(array2[mid]), othIsDefined = computed !== undefined, othIsNull = computed === null, othIsReflexive = computed === computed, othIsSymbol = isSymbol(computed);
              if (valIsNaN) {
          ...
          function reorder(array2, indexes) {
            ...
            while (length--) {
              var index = indexes[length];
              array2[length] = isIndex(index, arrLength) ? oldArray[index] : undefined;
            }
            return array2;
          }
          ...
          function chunk(array2, size2, guard) {
            if (guard ? isIterateeCall(array2, size2, guard) : size2 === undefined) {
              size2 = 1;
            } else {
          ...
          var differenceWith = baseRest(function(array2, values2) {
            ...
            return isArrayLikeObject(array2) ? baseDifference(array2, baseFlatten(values2, 1, isArrayLikeObject, true), undefined, comparator) : [];
          });
          ...
          function head(array2) {
            return array2 && array2.length ? array2[0] : undefined;
          }
          ...
          function nth(array2, n) {
            return array2 && array2.length ? baseNth(array2, toInteger(n)) : undefined;
          }
          ...
          function pullAllWith(array2, values2, comparator) {
            return array2 && array2.length && values2 && values2.length ? basePullAll(array2, values2, undefined, comparator) : array2;
          }
          ...
          function uniqWith(array2, comparator) {
            comparator = typeof comparator == "function" ? comparator : undefined;
            return array2 && array2.length ? baseUniq(array2, undefined, comparator) : [];
          }
          ...
          function max(array2) {
            return array2 && array2.length ? baseExtremum(array2, identity, baseGt) : undefined;
          }
          function maxBy(array2, iteratee2) {
            return array2 && array2.length ? baseExtremum(array2, getIteratee(iteratee2, 2), baseGt) : undefined;
          }
          ...
          function min(array2) {
            return array2 && array2.length ? baseExtremum(array2, identity, baseLt) : undefined;
          }
          function minBy(array2, iteratee2) {
            return array2 && array2.length ? baseExtremum(array2, getIteratee(iteratee2, 2), baseLt) : undefined;
          }
  ...
  var array = [1, 2, 1, 6, 8, 9, 2, 2, 9, 2, 0];
  var uniqueArray = uniq(array);
  console.log("Testcode updated!!!");
  console.log(uniqueArray, (0, import_lodash.sum)(uniqueArray));
})();
